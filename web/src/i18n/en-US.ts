export default {
  ...
  actionbar: {
    ...
    bitrateQualityDesc: '16 Mbps - Best visual',
    bitrateCustom: 'Custom',
    bitrateCustomDesc: 'Custom Mbps',
    gopPreset: 'GOP',
    gopLowLatency: 'Low latency (0.5s)',
    gopBalanced: 'Balanced (1s)',
    gopQuality: 'Quality (2s)',
    gopCustom: 'Custom',
    gopSeconds: 'sec',
  ...
  help: {
    ...
    videoBitratePreset: 'Speed: 1 Mbps. Balanced: 4 Mbps. Quality: 16 Mbps. Custom allows 0.25-100 Mbps.',
    videoGopPreset: 'GOP controls keyframe interval. Shorter intervals recover faster and seek better; longer intervals compress better. Custom is in seconds.',
