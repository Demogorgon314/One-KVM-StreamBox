export default {
  ...
  settings: {
    ...
    extSunshineSubtitle: 'Connect and control HDMI input through Moonlight/GameStream',
    ...
    hdrMode: 'HDR Mode',
    hdrAuto: 'Auto (Browser Compatible)',
    hdrSdrOnly: 'SDR Only',
    hdrPassthrough: 'HDR Passthrough (Experimental)',
  ...
  extensions: {
    ...
    sunshine: {
      title: 'Moonlight Remote',
      desc: 'Sunshine/GameStream compatible access for Moonlight clients',
      hostname: 'Host Name',
      appTitle: 'App Name',
      bind: 'Bind Address',
      ports: 'HTTP / HTTPS Ports',
      pairing: 'Pairing',
      pinPlaceholder: 'Enter Moonlight PIN',
