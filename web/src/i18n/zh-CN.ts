export default {
  ...
  actionbar: {
    ...
    bitrateQuality: '质量优先',
    bitrateQualityDesc: '16 Mbps - 最佳画质',
    bitrateCustom: '自定义',
    bitrateCustomDesc: '自定义 Mbps',
    gopPreset: 'GOP',
    gopLowLatency: '低延迟 (0.5秒)',
    gopBalanced: '均衡 (1秒)',
    gopQuality: '质量优先 (2秒)',
    gopCustom: '自定义',
    gopSeconds: '秒',
  ...
  help: {
    ...
    videoBitratePreset: '速度优先：1 Mbps；均衡：4 Mbps；质量优先：16 Mbps；自定义支持 0.25-100 Mbps。',
    videoGopPreset: 'GOP 控制关键帧间隔。间隔越短恢复越快、延迟越稳；间隔越长压缩效率越高。自定义单位为秒。',
