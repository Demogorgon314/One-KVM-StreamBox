export default {
  ...
  settings: {
    ...
    extSunshineSubtitle: '通过 Moonlight/GameStream 连接和控制 HDMI 输入',
  ...
  extensions: {
    ...
    sunshine: {
      title: 'Moonlight 远程',
      desc: '兼容 Sunshine/GameStream，用 Moonlight 客户端连接 One-KVM',
      hostname: '主机名称',
      appTitle: '应用名称',
      bind: '监听地址',
      ports: 'HTTP / HTTPS 端口',
      pairing: '配对',
      pinPlaceholder: '输入 Moonlight PIN',
      submitPin: '提交 PIN',
