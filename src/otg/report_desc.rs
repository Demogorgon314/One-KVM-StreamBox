...
/// Composite HID descriptor used on controllers that cannot enumerate multiple
/// HID functions reliably. Each input report is 8 bytes plus a report ID.
pub const COMPOSITE_KEYBOARD_POINTER: &[u8] = &[
    // Keyboard, Report ID 1, 8 byte payload
    0x05, 0x01, // Usage Page (Generic Desktop)
    0x09, 0x06, // Usage (Keyboard)
    0xA1, 0x01, // Collection (Application)
    ...
    0x81, 0x00, //   Input (Data, Array)
    0xC0, // End Collection
    // Relative mouse, Report ID 2, 8 byte payload
    0x05, 0x01, // Usage Page (Generic Desktop)
    0x09, 0x02, // Usage (Mouse)
    0xA1, 0x01, // Collection (Application)
    ...
    0xC0, //   End Collection
    0xC0, // End Collection
    // Absolute mouse, Report ID 3, 8 byte payload
    0x05, 0x01, // Usage Page (Generic Desktop)
    0x09, 0x02, // Usage (Mouse)
    0xA1, 0x01, // Collection (Application)
    ...
    0xC0, //   End Collection
    0xC0, // End Collection
    // Consumer control, Report ID 4, 8 byte payload
    0x05, 0x0C, // Usage Page (Consumer)
    0x09, 0x01, // Usage (Consumer Control)
    0xA1, 0x01, // Collection (Application)
...
mod tests {
    ...
    fn test_report_descriptor_sizes() {
        ...
        assert!(!COMPOSITE_KEYBOARD_POINTER.is_empty());
    }
}
